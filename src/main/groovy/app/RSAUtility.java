...
//			System.out.println(rsaPublicKey.toString());
			...
			throw new RuntimeException("生成密钥对 出现错误！", e);
		}
	}
	...
	public static  RSAPublicKey generateRSAPublicKey() {
		try {
			...
			throw new RuntimeException("获取公钥出现错误！", e);
		}
	}
	...
	public static  RSAPrivateKey generateRSAPrivateKey() {
		try {
			...
			throw new RuntimeException("获取私钥出现错误！", e);
	...
	public static  String encrypt(String dataStr) {
		try {
			...
			throw new RuntimeException("加密 出现错误！", e);
		}
	}
	...
	public static String decrypt(String rawStr) {
		try {
			...
			throw new RuntimeException("解密出现错误！", e);
		}
	}
	...
	public static String decryptStr(String paramStr) {
		...
		try {
			...
			throw new RuntimeException("JSP页面解密 出现错误！", e);
		}
	}
